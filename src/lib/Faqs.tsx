...
export const faq : ISection[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:   "You will need a form of photo identification (e.g. driving license, passport), as well as your QR code ticket on your phone. The name on your ticket must match the name on your identification. Please note that no individual under the age of 18 will be admitted to the event."
      },
      {
    ...
    questions: [
      {
        ...
        answer:   "Tickets go on sale to Murray Edwards students and registered alumnae at midday Sunday 17th February. There will be no general sale of tickets."
      },
      {
      ...
      },
      {
        ...
        answer:   "Each Murray Edwards student can purchase up to 4 tickets, including their own ticket, and each alumna can purchase up to 2 tickets."
      },
      {
        question: "I am an alumna of the college how do I go about buying tickets?",
        answer:   "Alumnae are required to register via email sent to president@megp19.com, your status as an alumna of the college will be verified by the Development Office. Registration must be completed by midday Saturday 9th of February. You will then be sent an email and code which will give you access to the ticketing system, one day before tickets go live at midday Saturday 16th February."
      },
      {
        question: "When do I have to complete registration by?",
        answer:   "Alumni registration will close midday Saturday 9th February. It is advisable that you buy your tickets on Saturday 16th February, as tickets will sell out once they go on release to current Murray Edwards students."
      },
      {
